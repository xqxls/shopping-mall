...
public class OmsPromotionServiceImpl implements OmsPromotionService {
        ...
        for (Map.Entry<Long, List<OmsCartItem>> entry : productCartMap.entrySet()) {
            ...
            if (promotionType == 1) {
                ...
                for (OmsCartItem item : itemList) {
                    ...
                    setItemAndAddList(cartPromotionItemList, promotionProduct, cartPromotionItem, skuStock, originalPrice.subtract(skuStock.getPromotionPrice()));
                }
                ...
                if(ladder!=null){
                    for (OmsCartItem item : itemList) {
                        ...
                        setItemAndAddList(cartPromotionItemList, promotionProduct, cartPromotionItem, skuStock, reduceAmount);
                    }
                }else{
    ...
    private void setItemAndAddList(List<CartPromotionItem> cartPromotionItemList, PromotionProduct promotionProduct, CartPromotionItem cartPromotionItem, PmsSkuStock skuStock, BigDecimal reduceAmount) {
