...
import com.xqxls.mall.domain.portal.service.UmsMemberCouponService;
...
public class UmsMemberCouponServiceImpl implements UmsMemberCouponService {
    ...
    @Autowired
    private SmsCouponHistoryDetailMapper smsCouponHistoryDetailMapper;
    @Autowired
    ...
    public List<SmsCouponHistoryDetail> listCart(List<CartPromotionItem> cartItemList, Integer type) {
        ...
        Date now = new Date();
        //获取该用户所有优惠券
        List<SmsCouponHistoryDetail> allList = smsCouponHistoryDetailMapper.getDetailList(currentMember.getId());
        //根据优惠券使用类型来判断优惠券是否可用
    ...
    public List<SmsCoupon> list(Integer useStatus) {
        ...
        return smsCouponHistoryDetailMapper.getCouponList(member.getId(),useStatus);
    }
